      ...
      <div className="p-20">
        ...
        <form onSubmit={handleSubmit(handleRegistration)} action="">
          <fieldset className="fieldset">
            ...
            <input className="input w-full" type="text" placeholder="Name" />
            ...
            <button className="btn mt-3 bg-primary text-black">Register</button>
          </fieldset>
          <div className="mt-2">
            <span className="text-gray-400">
              Already have an account?{" "}
              <a className="text-primary link link-hover" href="">
                Login
              </a>
            </span>
          </div>
        ...
        <div className="flex justify-center">
          <button className="bg-gray-300 lg:px-35 px-15 py-2 rounded 
